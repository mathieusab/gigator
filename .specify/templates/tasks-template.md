...
**Tests**: Include test tasks when requested in the feature specification OR when required by the constitution (security-sensitive changes, non-trivial logic).
